  ...
  <img
    ...
    <figure className="mt-10">
      <blockquote className="text-center text-xl/8 font-semibold text-gray-900 sm:text-2xl/9">
        <p>“Being a modern bike shop with traditional values of great, friendly service and a commitment to the local community, we make a point of carrying a huge range of affordable kids and family bikes, in a wide selection of colours.”</p>
      </blockquote>
      <figcaption className="mt-10">
        ...
        <div className="mt-4 flex items-center justify-center space-x-3 text-base">
          ...
          <div className="text-fuchsia-600">CEO of BicycleB </div>
        </div>
      </figcaption>
    </figure>
  </div>
