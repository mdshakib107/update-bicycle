...
const Hero = () => {
  ...
  return (
    <div className="w-full rounded-4xl shadow-purple-600 shadow-2xl flex flex-col justify-center items-center">
      {/* header */}
      <header className="flex h-full lg:flex-row-reverse flex-col-reverse gap-4 lg:gap-0 justify-center items-center ">
        <div className="px-8 mt-0  w-full lg:w-[60%] h-full py-4">
          <div className="flex flex-col items-center justify-center text-center space-y-6">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight transition-all duration-300 hover:scale-[1.02]">
              Discover Your Perfect Ride
            </h1>
            <p className="max-w-2xl text-lg md:text-xl text-gray-600 leading-tight text-justify lg:text-center">
